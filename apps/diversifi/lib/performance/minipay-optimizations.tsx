...
import { createLazyComponent, shouldLoadFeature } from "@stable-station/shared";

// Lightweight chart for MiniPay
export const LazyMiniPayChart = createLazyComponent(
  () => import("../components/SimplePieChart").then(m => ({ default: m.default })),
...
export const LazyRegionalIconography = createLazyComponent(
  () => import("../components/RegionalIconography").then(m => ({ default: m.default }))
);
