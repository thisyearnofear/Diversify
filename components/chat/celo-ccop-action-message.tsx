...
export function CeloCcopActionMessage({
  message,
  onComplete,
}: CeloCcopActionMessageProps) {
      ...
      <div className="flex-1 space-y-2 overflow-hidden px-1">
        <div className="space-y-1.5">
          ...
          <div className="prose prose-sm max-w-none">
            <p>
              Get cCOP stablecoins on Celo. cCOP is a stablecoin pegged to the
              Colombian Peso.
            </p>
          </div>
        </div>
          ...
          <div className="mt-4 space-y-4">
            <Card className="overflow-hidden">
              <div className="bg-muted p-4">
                <h3 className="font-semibold">Get cCOP Stablecoins</h3>
                <p className="text-sm text-muted-foreground mt-1">
                  Follow these steps to get cCOP stablecoins on Celo.
                </p>
              </div>
              <div className="p-4 space-y-4">
                <div className="space-y-4">
                  <DivviRegistrationCardCompact chain="celo" />
                  <CeloCcopSwapCardCompact isRegistered={isRegistered} />
                </div>
              </div>
            </Card>
          </div>
