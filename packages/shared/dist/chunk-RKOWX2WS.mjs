...
var require_use_sync_external_store_shim_production = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    "use strict";
    var React9 = __require("react");
    function is(x, y) {
      return x === y && (0 !== x || 1 / x === 1 / y) || x !== x && y !== y;
    }
    var objectIs = "function" === typeof Object.is ? Object.is : is;
    var useState6 = React9.useState;
    var useEffect9 = React9.useEffect;
    var useLayoutEffect = React9.useLayoutEffect;
...
var require_use_sync_external_store_shim_development = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      var React9 = __require("react"), objectIs = "function" === typeof Object.is ? Object.is : is, useState6 = React9.useState, useEffect9 = React9.useEffect, useLayoutEffect = React9.useLayoutEffect, useDebugValue = React9.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
      exports.useSyncExternalStore = void 0 !== React9.useSyncExternalStore ? React9.useSyncExternalStore : shim;
...
var require_with_selector_production = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.production.js"(exports) {
    ...
    var useRef3 = React9.useRef;
    var useEffect9 = React9.useEffect;
    var useMemo2 = React9.useMemo;
    var useDebugValue = React9.useDebugValue;
...
var require_with_selector_development = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React9 = __require("react"), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore7 = shim.useSyncExternalStore, useRef3 = React9.useRef, useEffect9 = React9.useEffect, useMemo2 = React9.useMemo, useDebugValue = React9.useDebugValue;
      exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
        var instRef = useRef3(null);
        if (null === instRef.current) {
          var inst = { hasValue: false, value: null };
...
function shouldLoadFeature(feature) {
  ...
  return ((_a = featureFlags[environment]) == null ? void 0 : _a[feature]) ?? true;
}
...
function LoadingFallback({ environment = "standard", message = "Loading..." }) {
  const isEnhanced = environment === "enhanced";
  return /* @__PURE__ */ React.createElement("div", { className: `flex items-center justify-center p-4 ${isEnhanced ? "bg-white" : "bg-gray-50"}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-2" }, /* @__PURE__ */ React.createElement("div", { className: `animate-spin rounded-full h-4 w-4 border-2 border-t-transparent ${isEnhanced ? "border-blue-500" : "border-gray-400"}` }), /* @__PURE__ */ React.createElement("span", { className: `text-sm ${isEnhanced ? "text-gray-700" : "text-gray-600"}` }, message)));
}
function LazyComponentLoader({
  ...
  const environment = forceEnvironment || AppEnvironment.getType();
  const isEnhanced = environment === "enhanced";
  const loader = isEnhanced && enhancedLoader ? enhancedLoader : standardLoader;
  const LazyComponent = lazy(loader);
  const fallback = FallbackComponent ? /* @__PURE__ */ React.createElement(FallbackComponent, { ...componentProps }) : /* @__PURE__ */ React.createElement(LoadingFallback, { environment, message: loadingMessage });
  return /* @__PURE__ */ React.createElement(Suspense, { fallback }, /* @__PURE__ */ React.createElement(LazyComponent, { ...componentProps }));
}
function createLazyComponent(standardLoader, enhancedLoader) {
  return function LazyWrapper(props) {
    const { loadingMessage, forceEnvironment, ...componentProps } = props;
...
var LazyChart = createLazyComponent(
  () => import("./CurrencyPerformanceChart-RDN7UKAL.mjs").then((m) => ({ default: m.CurrencyPerformanceChart }))
);
function useComponentPreloader() {
  const environment = AppEnvironment.getType();
  const preloadComponent = React.useCallback((loader) => {
  ...
  const preloadForEnvironment = React.useCallback((standardLoader, enhancedLoader) => {
    const loader = environment === "enhanced" && enhancedLoader ? enhancedLoader : standardLoader;
    preloadComponent(loader);
  }, [environment, preloadComponent]);
  return {
    preloadComponent,
    preloadForEnvironment,
    environment
  };
}
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1 } = await import("./secp256k1-2QEVHXG6.mjs");
  const signature_ = (() => {
...
var QueryObserver = class extends Subscribable {
  ...
  createResult(query, options) {
    ...
    if (options.select && newState.data !== void 0) {
      if (prevResult && newState.data === (prevResultState == null ? void 0 : prevResultState.data) && options.select === this.#selectFn) {
...
import { useState as useState5, useCallback as useCallback5, useEffect as useEffect7 } from "react";
...
function CurrencyPerformanceChart({
  ...
  return /* @__PURE__ */ React8.createElement("div", { className: "w-full" }, /* @__PURE__ */ React8.createElement(
    "canvas",
    {
      ref: canvasRef,
  ...
  ), data.source && /* @__PURE__ */ React8.createElement("p", { className: `text-xs mt-2 ${chartEnvironment === "enhanced" ? "text-gray-600" : "text-gray-500"}` }, "Data source: ", data.source === "api" ? "Live API" : "Cached"));
}
